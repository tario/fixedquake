...
void rb_loaderror __((const char*, ...));
void rb_name_error __((ID, const char*, ...));
void rb_invalid_str _((const char*, const char*));
void rb_compile_error __((const char*, ...));
void rb_compile_error_append __((const char*, ...));
void rb_load_fail _((const char*));
void rb_error_frozen _((const char*));
void rb_check_frozen _((VALUE));
/* eval.c */
RUBY_EXTERN struct RNode *ruby_current_node;
void ruby_set_current_source _((void));
void rb_exc_raise _((VALUE));
void rb_exc_fatal _((VALUE));
